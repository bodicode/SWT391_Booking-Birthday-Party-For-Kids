<%-- 
    Document   : managePTH
    Created on : Mar 1, 2024, 10:33:50 AM
    Author     : Minh
--%>
                ...
                <main class="content px-3 py-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card border-0">
                            ...
                            <c:if test="${not empty requestScope.LIST_HOST}" >
                                <div class="card-body">
                                    <table class="table">
                                       <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <c:forEach var="host" items="${requestScope.LIST_HOST}" varStatus="counter">
                                            <tr>
