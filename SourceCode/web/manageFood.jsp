<%-- 
    Document   : manageFood
    Created on : Mar 8, 2024, 8:35:45 AM
    Author     : User
--%>
                ...
                <main class="content px-3 py-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card border-0">
                            ...
                            <c:if test="${not empty requestScope.FOOD_LIST}" >
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                        <c:forEach var="food" items="${requestScope.FOOD_LIST}" varStatus="counter">
                                            <tr>
                                            <tr>
                                                <th scope="row">${counter.count}</th>
                                                <td>${food.foodID}</td>
                                                <td>${food.getFoodName()}</td>
                                                <td>${food.getFoodImageURL()}</td>
                                                <td>${food.getPrice()}$</td>
                                            </tr>
                                            </tr>
                                        </c:forEach>
