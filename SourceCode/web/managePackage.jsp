<%-- 
    ...
    Created on : Mar 8, 2024, 8:55:21 AM
    Author     : User
--%>
                ...
                <main class="content px-3 py-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card border-0">
                            ...
                            <c:if test="${not empty requestScope.PACKAGE_LIST}" >
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <c:forEach var="package" items="${requestScope.PACKAGE_LIST}" varStatus="counter">
                                                <tr>
                                                    <th scope="row">${counter.count}</th>
                                                    <td>${package.getPackageID()}</td>
                                                    <td>${package.getPackageName()}</td>
                                                    <td>${package.getPackageDescription()}</td>
                                                    <td>${package.getPrice()}$</td>
                                                    <td>${package.getPackageImageURL()}$</td>
                                                </tr>
